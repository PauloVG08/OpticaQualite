...
-- Vista que obtiene todos los datos de los productos
...
CREATE VIEW v_productos AS
	SELECT 	P.idProducto,
            ...
            P.precioVenta, 
            P.existencias
    FROM producto P, accesorio a, solucion s WHERE s.idProducto = P.idProducto OR 
    a.idProducto = P.idProducto GROUP BY P.codigoBarras;
...
-- Vista que obtiene todos los datos de los materiales  
...
-- Vista que obtiene todos los datos de los materiales  
DROP VIEW IF EXISTS v_tipo_micas;
CREATE VIEW v_tipo_micas AS
    SELECT  tm.*
    FROM    tipo_mica tm;
    

-- Vista que obtiene todos los datos de los materiales  
DROP VIEW IF EXISTS v_tratamientos;
