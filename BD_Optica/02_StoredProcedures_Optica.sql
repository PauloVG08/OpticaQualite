...
CREATE PROCEDURE insertarEmpleado(	/* Datos Personales */
                                    ...
                                    OUT	var_numeroUnico     VARCHAR(65),    -- 22
                                    OUT var_lastToken       VARCHAR(65)	-- 23 #Por seguridad (Más practico que el usuario y contraseña 
				)                                    
    BEGIN        
...
CREATE PROCEDURE actualizarEmpleado(	/* Datos Personales */
                                    ...
                                    /* IDs */
                                    IN	var_idPersona       INT,            -- 19
                                    IN	var_idUsuario       INT,            -- 20
                                    IN	var_idEmpleado      INT             -- 21
				)                                    
    BEGIN        
        ...
        UPDATE persona  SET nombre = var_nombre, apellidoPaterno = var_apellidoPaterno, 
                            ...
                            telcasa = var_telcasa, telmovil = var_telmovil, email = var_email, rfc=var_rfc 
...
CREATE PROCEDURE insertarLenteContacto(	/* Datos del Producto */
    ...
    BEGIN        
        ...
        -- Finalmente, insertamos en la tabla lente contacto:
        INSERT INTO lente_contacto (idProducto, keratometria, fotografia)
                    VALUES(var_idProducto, var_queratometria, var_fotografia);
        -- Obtenemos el ID del lente de contacto que se genero:
        SET var_idLenteContacto = LAST_INSERT_ID();
        
        -- Generamos su codigo de barras:
        SET var_codigoBarras = CONCAT('OQ-P', var_idProducto, '-A', var_idLenteContacto);
...
-- Stored Procedure para actualizar datos de lentes de contactos.
...
CREATE PROCEDURE actualizarLenteContacto(	/* Datos del Producto */
    ...
    BEGIN        
        ...
        UPDATE producto SET nombre = var_nombre, marca = var_marca, 
                        ...
                        -- Actualizamos la tabla de lente de contacto
                        UPDATE lente_contacto SET keratometria = var_queratometria,
                        fotografia = var_fotografia
