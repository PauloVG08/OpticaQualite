...
CREATE TABLE presupuesto(
    idPresupuesto       INT AUTO_INCREMENT PRIMARY KEY NOT NULL,
     idExamenVista       INT, -- Con el examen de la vista llegamos a los datos del cliente
    clave               VARCHAR(65)
);
...
ADD CONSTRAINT fk_presupuesto_examen_vista
FOREIGN KEY (idExamenVista) REFERENCES examen_vista(idExamenVista);
...
CREATE TABLE presupuesto_lentes(
	...
	CONSTRAINT fk_presupuestolentes_examenvista FOREIGN KEY (idExamenVista)
...
CREATE TABLE presupuesto_lentescontacto(
	...
	CONSTRAINT fk_presupuestolentescontacto_presupuesto FOREIGN KEY (idPresupuesto)
				REFERENCES presupuesto(idPresupuesto)
